...
def get_data(ticker, interval="15m"):
    # टाइमफ्रेम के हिसाब से डेटा की अवधि (Period) सेट करना
...
def get_chart_html(ticker, interval):
    ...
    fig.update_layout(template="plotly_dark", height=550, margin=dict(l=0,r=0,t=0,b=0), xaxis_rangeslider_visible=False, paper_bgcolor='#131722', plot_bgcolor='#131722')
    ...
    <body>
        ...
        <div style="display:flex; gap:20px; flex-wrap:wrap;">
            <div class="card" style="flex:1; min-width:350px; max-height:650px; overflow-y:auto;">
                <!-- Search बार वापस जोड़ दिया गया है -->
            ...
            <div class="card" style="flex:2.5; min-width:550px;">
                <div style="display:flex; justify-content:space-between; margin-bottom:10px;">
                    ...
                    <div>{tf_btns}</div> <!-- Timeframe बटन वापस जोड़ दिए गए हैं -->
                </div>
